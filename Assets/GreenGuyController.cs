...
public class GreenGuyController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!isHit)
        {
            ...
            {
                GetComponent<Animator>().SetInteger("moveStateGreenGuy", 2); // Set jump animation
            }
            else if (!isGrounded && verY < 0)
            {
                GetComponent<Animator>().SetInteger("moveStateGreenGuy", 3); // Set fall animation
            }
            else if (isGrounded && horX > 0)
            {
                GetComponent<Animator>().SetInteger("moveStateGreenGuy", 1); // Set run animation
            ...
            {
                GetComponent<Animator>().SetInteger("moveStateGreenGuy", 0); // Set idle animation
            }
        }
    ...
    {
        isHit = true;
        GetComponent<Animator>().SetInteger("moveStateGreenGuy", 4);
