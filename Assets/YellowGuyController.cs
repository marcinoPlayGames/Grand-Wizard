...
public class YellowGuyController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!isHit)
        {
            ...
            {
                GetComponent<Animator>().SetInteger("moveStateYellowGuy", 2); // Set jump animation
            }
            else if (!isGrounded && verY < 0)
            {
                GetComponent<Animator>().SetInteger("moveStateYellowGuy", 3); // Set fall animation
            }
            else if (isGrounded && horX > 0)
            {
                GetComponent<Animator>().SetInteger("moveStateYellowGuy", 1); // Set run animation
            ...
            {
                GetComponent<Animator>().SetInteger("moveStateYellowGuy", 0); // Set idle animation
            }
        }
    ...
    {
        isHit = true;
        GetComponent<Animator>().SetInteger("moveStateYellowGuy", 4);
